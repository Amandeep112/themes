...
>(
    (
        { id, children, className, iconAlignment, disable, style, tabIndex },
        ref,
    ) => {
        ...
        const getIcon = () =>
            itemCtx?.isExpanded || itemCtx?.error
        ...
        }, [itemCtx?.isExpanded, itemCtx?.error, themeMode]);
