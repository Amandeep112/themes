...
>(
    (
        ...
        const [isErrorType, setIsErrorType] = React.useState(false);

        /** To update error states for open and close accordion */
        useEffect(() => {
            setIsErrorType(isError);
        }, [isError]);
        ...
        }, [isErrorType, toggleExpand, isExpanded]);
        return (
