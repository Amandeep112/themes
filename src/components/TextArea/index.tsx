    ...
    (
        ...
        React.useEffect(() => {
            if (maxLength && maxLength > 0) {
                ...
                if (limitCharacter && value.length === 0) {
                    limitCharacter.textContent = `Maximum ${maxLength} characters.`;
                    limitCharacter.style.color = "";
                    limitCharacter.parentElement?.classList.remove(
                        "reached_limit_error",
                    );
                }
            }
        ...
        //     const { id } = e.target as HTMLTextAreaElement;
        //     const maxLen = maxLength;
        //     const remainingText = document.getElementById(`character_length_${id}`);
        //     if (maxLen) {
        //         const counter =
        //             maxLen - (e.target as HTMLTextAreaElement).value.length;
        //         const remainingText = document.getElementById(
